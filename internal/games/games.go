...
func (g *AttentionGame) Name() string { return "Hawkeye" }
func (g *AttentionGame) Type() string { return "attention" }
...
func (g *AttentionGame) RunRound(difficulty int) (*GameResult, error) {
	...
	baseAcc := []float64{0.6, 0.7, 0.8, 0.9, 0.95}
	accuracy := baseAcc[difficulty%5]
	if !targetFound {
		accuracy *= 0.7
	}
...
func (g *MemoryGame) Name() string { return "Target Tracker" }
func (g *MemoryGame) Type() string { return "memory" }

func (g *MemoryGame) RunRound(difficulty int) (*GameResult, error) {
	start := time.Now()
	
	trackedCorrectly := rand.Float64() < 0.5+float64(difficulty)*0.1
...
func (g *SpeedGame) Name() string { return "Speed Reaction" }
func (g *SpeedGame) Type() string { return "speed" }
...
func (g *LogicGame) Name() string { return "Pattern Logic" }
func (g *LogicGame) Type() string { return "logic" }
